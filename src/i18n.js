const translations = {
  fr: {
    ...
    magasinEquipement: 'Magasin d\'equipement',
    wipLabel: 'En construction',
    buildingBuilt: '{name} ameliore !',
    entrepotEffect: '+5 capacite de stockage',
    stationServiceEffect: '+1 vitesse',
    marcheEffect: '+10% prix de vente',
    magasinEquipementEffect: '+1.5 rayon de collecte',
    concessionEffect: 'Achat de vehicules (bientot)',
    // Obstacle chantiers
  ...
  en: {
    ...
    magasinEquipement: 'Equipment Shop',
    wipLabel: 'Coming Soon',
    buildingBuilt: '{name} upgraded!',
    entrepotEffect: '+5 storage capacity',
    stationServiceEffect: '+1 speed',
    marcheEffect: '+10% sell price',
    magasinEquipementEffect: '+1.5 collect radius',
